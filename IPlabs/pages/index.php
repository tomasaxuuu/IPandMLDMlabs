...
<body>
    <div class="fixed">
        <header id="header">
            <a class="logo" href="#">Laboratories</a>
    ...
    <main>
        <div class="center">
            <div class="text">
                This is my personal page for working with projects, I ask you not to be shy and ask me questions! I will be stronger!
            </div>
            <a class="labs" href="../pages/Labs.php"><button class="laboratories" type="submit">Laboratories</button></a>
        </div>
    </main>
</body>
</html>